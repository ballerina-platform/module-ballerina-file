...
The File library specification has evolved and may continue to evolve in the future. Released versions of the specification can be found under the relevant Github tag.
...
4. [Path Operations](#4-path-operations)
   ...
   * 4.4 [Get Parent Path](#44-get-parent-path)
   * 4.5 [Normalize Path](#45-normalize-path)
   * 4.6 [Split Path](#46-split-path)
   * 4.7 [Join](#47-join-path)
   * 4.8 [Get Relative Path](#48-get-relative-path)
