...
/**
 * Represents a post-processing action to perform on a file after a remote function completes.
 * Can be either a DELETE or a MOVE action.
 */
public final class PostProcessAction {

    /**
     * Kind of post-processing action.
     */
     ...
     * @param preserveSubDirs Whether to preserve the subdirectory structure relative to the watched directory
